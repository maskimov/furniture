  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
      <form class="text-center" method="post">
        ...
        <h1 class="h3 mb-3 fw-normal">Увійдіть в акаунт</h1>

        <div class="form-floating">
          <input type="text" name="username" class="form-control" id="floatingInput" placeholder="ім'я">
        ...
        <p class="mt-3 mb-3 text-body-secondary">Забули пароль? <a href="<?=ROOT?>/resetpassword">Скинути</a></p>
